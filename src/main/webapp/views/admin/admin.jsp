                ...
                <form class="card w-100 p-3" method="post" action="Admin?offerAction=add" enctype="multipart/form-data">
                        ...
                        <div class="col-md-8">
                            <div class="card-body d-flex justify-content-between">
                                <div class="w-50">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input type="text" class="form-control" id="squareNew" name="square" required>
                                        <label for="squareNew">Square</label>
                                    </div>
                                ...
                                <div class="mb-3 ms-2">
                                    <label for="uploadPhotosNew" class="form-label">Upload images</label>
                    ...
                    <div class="d-flex align-items-center mb-3 down-panel flex-wrap">
                        ...
                        <div class="form-check form-switch">
                            <input class="form-check-input" type="checkbox" role="switch" id="balconyNew" name="balcony">
                            <label class="form-check-label" for="balconyNew">Balcony</label>
                        </div>
                        <div class="form-floating ms-auto price-cont">
                            <input type="text" class="form-control" id="priceNew" name="price" value="0" required>
        ...
        <div class="m-3">
            <form class="card w-100 p-3" method="post" action="Admin?offerAction=update" enctype="multipart/form-data">
                    ...
                    <div class="col-md-8">
                        <div class="card-body d-flex justify-content-between">
                            <div class="w-50">
                                ...
                                <div class="form-floating mb-3">
                                    <input type="text" class="form-control" id="square" name="square" value="<%=offer.offer.square%>" required>
                            ...
                            <div class="w-50">
                                ...
                                <div class="mb-3 ms-3">
                                    <label for="uploadPhotos" class="form-label">Upload images</label>
                ...
                <div class="d-flex align-items-center mb-3 down-panel flex-wrap">
                    ...
                    <div class="form-floating ms-auto price-cont">
                        <input type="text" class="form-control" id="price" name="price" value="<%=offer.offer.price%>" required>
                        <label for="price">Price</label>
                    </div>
                </div>
                <div class="d-flex">
                    <button type="submit" value="apply" name="itemAction" class="btn btn-primary me-3">Apply changes</button>
                    <button type="submit" value="delete" name="itemAction" class="btn btn-danger">Delete offer</button>
                </div>
            </form>
        </div>
        <%}%>
